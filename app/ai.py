    ...
    async def decide_and_answer(self, chat_id: int, user_text: str) -> str:
        ...
        messages = [
            ...
            {"role": "system", "content": (
                ...
                "ЕСЛИ ЕСТЬ СТРОКИ `Игрок: ... | Кот: ... | Продажа: ... | Покупка: ... | Координаты: ...`, "
                "это структурированные данные самой базы котов. Считай их приоритетным источником. "
                "Если в строке указан игрок, цена продажи или координаты — сообщай именно эти данные. "
                "Не говори, что продавец не указан, если он есть в структурированной строке. "
                "Не смешивай поля разных строк между собой. Если пользователь спрашивает `где купить`, "
                "в первую очередь дай найденного игрока, цену продажи и координаты."
            )},
